...
def starting_hp():
    """Splitting txt file and store as nested lists """

    master_list =[]
    harry_potter_data = open("cohort_data.txt")
    # loop over txt file
    for line in harry_potter_data:
    #split file by |
        split_hp_data = line.split("|")
        master_list.append(split_hp_data)
    return master_list

#Gets the global variable master_list to use later
master_list = starting_hp()

def unique_houses(master_list):
    ...
    """
    #the function will look for the house names and add to set
    houses = set()
    # Code goes here
...
def sort_by_cohort(filename):
    ...
    # Code goes here
    #if cohort is winter_16 
        #append person[4] to winter_16 LIST
